...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    filename: utils.assetsPath('js/[hash:7]/[name].js'),
    chunkFilename: utils.assetsPath('js/[hash:7]/[id].js')
  },
  vue: {
  ...
  plugins: [
    ...
    config.build.linkCss && new ExtractTextPlugin(utils.assetsPath('css/[name].css')),
    ...
    new Manifest({
      cache: [
        'js/[hash:7]/app.js',
        'img/[hash:7]/gotop.png',
        'https://s95.cnzz.com/z_stat.php?id=1261043262&web_id=1261043262'
      ],
